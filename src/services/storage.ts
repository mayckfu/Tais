...
export const INITIAL_REQUESTS: DeficitRequest[] = [
  {
    ...
    relocations: [
      {
        ...
        authorizedRole: 'DENF',
        authorizedAt: '07:18',
        confirmedArrivalBy: 'Enfª. Mariana Costa',
        confirmedArrivalRole: 'Enfermeira de Plantão - UTI',
        confirmedArrivalAt: '07:30',
      ...
      },
      {
        ...
        authorizedRole: 'DENF',
        authorizedAt: '07:18',
        notes: 'Profissional liberada no CME às 07:25. Em deslocamento para a UTI Geral. Aguarda confirmação de chegada pela Enfª Mariana Costa no posto da UTI.',
      },
    ],
    impactAssessment: {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: 'Téc. Carla Regina e Téc. Sandra Mara liberadas no CME pela Dra. Patrícia Valente para deslocamento até a UTI.',
        user: 'Dra. Patrícia Valente',
        type: 'relocation',
      },
      {
        id: 'tl-6',
        timestamp: '07:30',
        title: 'Apresentação e início de cobertura (Téc. Carla)',
        description: 'Enfª. Mariana Costa confirmou a apresentação da Téc. Carla Regina na UTI (leitos 05 a 08). Téc. Sandra Mara a caminho do setor.',
        user: 'Enfª. Mariana Costa',
        type: 'relocation',
      },
      {
...
const STORAGE_KEYS = {
  REQUESTS: 'hospital_deficit_requests_v5',
  SETTINGS: 'hospital_deficit_settings_v5',
  USERS: 'hospital_deficit_users_v5',
  FOLLOWUPS: 'hospital_deficit_followups_v5',
  ALERTS: 'hospital_deficit_alerts_v5',
  ACTIVE_USER: 'hospital_deficit_active_user_v5',
};
